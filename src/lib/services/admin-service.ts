...
import { AdminArticle, AdminUser, GlossaryTerm, APIKeyNode, AdPlacement, SystemConfig } from '@/types/admin-system';
...
class AdminService {
  ...
  getArticles(): AdminArticle[] {
    return this.getStorage('articles', [
      { id: '1', slug: 'macro-outlook-2026', title: 'Macro Outlook 2026', content: 'Full analysis text...', summary: 'The future of interest rates.', category: 'Economics', status: 'published', authorId: 'u-1', updatedAt: '2024-03-15', tags: ['Macro'] },
      { id: '2', slug: 'yield-curve-basics', title: 'Yield Curve Basics', content: 'Educational content...', summary: 'Intro to bond markets.', category: 'Investing', status: 'draft', authorId: 'u-1', updatedAt: '2024-03-14', tags: ['Bonds'] }
    ]);
  }
  ...
  saveArticle(article: AdminArticle) {
    ...
    if (index > -1) {
      ...
      articles.push({ ...article, id: Date.now().toString(), updatedAt: new Date().toISOString() });
    }
  ...
  getUsers(): AdminUser[] {
    return this.getStorage('users', [
      { id: 'u-1', name: 'Eleanor Vance', email: 'eleanor@imperialpedia.com', role: 'Super Admin', status: 'active', lastActive: '2m ago' },
      { id: 'u-2', name: 'Julian Wealth', email: 'julian@wealth.com', role: 'Editor', status: 'active', lastActive: '1h ago' },
      { id: 'u-3', name: 'Sarah Crypto', email: 'sarah@web3.io', role: 'Writer', status: 'active', lastActive: '4h ago' }
    ]);
  }
  ...
  getTerms(): GlossaryTerm[] {
    return this.getStorage('glossary', [
      { id: 'g1', term: 'Stagflation', definition: 'High inflation + Low growth.', category: 'Economics', linkedArticles: ['1'] },
      { id: 'g2', term: 'Arbitrage', definition: 'Simultaneous purchase and sale.', category: 'Trading', linkedArticles: [] }
    ]);
  }
  ...
  getApiKeys(): APIKeyNode[] {
    return this.getStorage('api_keys', [
      { id: 'k1', service: 'Claude 3.5 Sonnet', key: 'sk-ant-...', status: 'active', usage: '42%' },
      { id: 'k2', service: 'AlphaVantage Market', key: 'AV-99...', status: 'active', usage: '12%' }
    ]);
  }
