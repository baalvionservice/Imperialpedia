...
const navItems = [
  ...
  { label: 'AI Lab', href: '/admin/ai', icon: Brain },
  ...
  { label: 'Experts', href: '/admin/authors', icon: UserCheck },
  ...
  { label: 'Global', href: '/admin/global', icon: Globe },
  { label: 'News AI', href: '/admin/news-ai', icon: Zap },
