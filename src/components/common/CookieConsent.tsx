...
export const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-[100] p-4 lg:p-6 animate-in slide-in-from-bottom-full duration-1000">
      <Container isNarrow>
        <div className="glass-card bg-background/95 backdrop-blur-xl border-primary/20 shadow-2xl rounded-[2rem] p-6 lg:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
            <Button 
              variant="ghost" 
              size="sm"
              className="flex-1 md:flex-none h-11 px-4 rounded-xl text-[10px] font-bold uppercase tracking-widest text-muted-foreground hover:text-primary transition-all"
      ...
      {/* TODO: Multi-language support for privacy banner */}
    </div>
  );
};
