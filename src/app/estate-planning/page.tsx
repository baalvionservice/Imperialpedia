...
export const metadata = buildMetadata({
  ...
  description:
    "Stay informed with the latest estate planning strategies, wealth transfer techniques, and inheritance planning. Our estate planning section covers wills, trusts, and legacy planning.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Plan your legacy with comprehensive estate planning strategies, wealth transfer techniques, and inheritance planning for future generations."
      />
