...
export const metadata = buildMetadata({
  title: "Financial Advisor Reviews and Wealth Management Services",
  description:
    "Stay informed with the latest financial advisor reviews, wealth management service comparisons, and advisory firm analysis. Our advisor reviews section covers fees, services, and expertise.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Compare financial advisors, wealth management firms, and advisory services to find the right professional guidance for your financial goals."
      />
