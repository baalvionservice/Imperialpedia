...
export const metadata = buildMetadata({
  ...
  description:
    "Stay informed with the latest financial planning strategies, wealth management techniques, and long-term financial goal setting. Our planning section covers comprehensive financial planning approaches.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Create comprehensive financial plans, set long-term goals, and build wealth through strategic financial planning and disciplined execution."
      />
