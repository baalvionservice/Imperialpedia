...
export const metadata = buildMetadata({
  title: "Global Economy and International Markets",
  description:
    "Stay informed with the latest global economy news, international market analysis, and worldwide economic trends. Our global section covers international trade, currencies, and global markets.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Explore international markets, global economic trends, and worldwide financial developments that impact investment opportunities and market dynamics."
      />
