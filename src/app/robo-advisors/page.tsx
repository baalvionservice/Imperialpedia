...
export const metadata = buildMetadata({
  title: "Robo-Advisor Reviews and Automated Investing",
  description:
    "Stay informed with the latest robo-advisor reviews, automated investing platforms, and digital wealth management services. Our robo-advisor section covers fees, performance, and features.",
});

// ─── Page ────────────────────────────────────────────────────────────────────

export default function RoboAdvisorsPage() {
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Compare robo-advisors, automated investing platforms, and digital wealth management services for hands-off portfolio management."
      />
