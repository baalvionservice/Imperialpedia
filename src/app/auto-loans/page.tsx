...
export const metadata = buildMetadata({
  title: "Auto Loans and Vehicle Financing",
  description:
    "Stay informed with the latest auto loan rates, vehicle financing options, and car buying strategies. Our auto loans section covers loan comparisons, rates, and financing tips.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        tag="BANKING"
        title={"Auto Loans"}
        description="Compare auto loan rates, understand vehicle financing options, and learn strategies for securing the best car loan terms and rates."
      />
