...
export const metadata = buildMetadata({
  title: "Money Market Accounts and High-Yield Options",
  description:
    "Stay informed with the latest money market account rates, features, and benefits. Our money market section covers account comparisons, interest rates, and liquidity options.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Explore money market accounts that combine higher interest rates with checking account flexibility for optimal cash management."
      />
