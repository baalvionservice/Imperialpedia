...
export const metadata = buildMetadata({
  title: "Credit Cards and Rewards Programs",
  description:
    "Stay informed with the latest credit card offers, rewards programs, and credit card news. Our credit cards section covers card comparisons, benefits, and credit building strategies.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        tag="BANKING"
        title={"Credit Cards"}
        description="Compare credit cards, maximize rewards programs, and learn strategies for building credit while managing debt responsibly."
      />
