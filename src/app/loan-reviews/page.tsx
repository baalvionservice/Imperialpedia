...
export const metadata = buildMetadata({
  title: "Loan Reviews and Lender Comparisons",
  description:
    "Stay informed with the latest loan reviews, lender comparisons, and lending service analysis. Our loan reviews section covers personal loans, mortgages, and lending platforms.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        tag="REVIEWS"
        title={"Loan Reviews"}
        description="Compare lenders, loan products, and lending platforms to find the best loan terms and rates for your borrowing needs."
      />
