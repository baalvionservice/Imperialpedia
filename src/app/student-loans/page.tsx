...
export const metadata = buildMetadata({
  title: "Student Loans and Education Financing",
  description:
    "Stay informed with the latest student loan news, education financing options, and loan repayment strategies. Our student loans section covers federal loans, private loans, and forgiveness programs.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        tag="BANKING"
        title={"Student Loans"}
        description="Navigate student loan options, understand repayment strategies, and explore forgiveness programs for managing education debt effectively."
      />
