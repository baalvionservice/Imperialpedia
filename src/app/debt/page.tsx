...
export const metadata = buildMetadata({
  title: "Debt Management and Debt Relief Strategies",
  description:
    "Stay informed with the latest debt management strategies, debt relief options, and financial recovery techniques. Our debt section covers debt consolidation, payoff strategies, and credit repair.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Learn effective debt management strategies, consolidation options, and payoff techniques to achieve financial freedom and improve your credit."
      />
