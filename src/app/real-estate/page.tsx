...
export const metadata = buildMetadata({
  title: "Real Estate Investing and Property Markets",
  description:
    "Stay informed with the latest real estate investing news, property market analysis, and real estate investment strategies. Our real estate section covers REITs, rental properties, and market trends.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Explore real estate investment opportunities, property markets, REITs, and strategies for building wealth through real estate."
      />
