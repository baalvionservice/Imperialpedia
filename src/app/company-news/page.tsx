...
export const metadata = buildMetadata({
  title: "Company News and Analysis",
  description:
    "Stay informed with the latest company news, corporate insights, and business analysis. Our company news section covers earnings, mergers, acquisitions, and corporate strategies to help you make informed decisions.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        tag="NEWS"
        title={"Company News"}
        description="Stay updated with the latest corporate developments, earnings reports, and business strategies from companies across all sectors."
      />
