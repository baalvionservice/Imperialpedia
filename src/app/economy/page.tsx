...
export const metadata = buildMetadata({
  title: "Economy News and Economic Analysis",
  description:
    "Stay informed with the latest economic news, market analysis, and economic indicators. Our economy section covers GDP, inflation, employment, and monetary policy to help you understand economic trends.",
});
...
export default function EconomyPage() {
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        tag="ECONOMY"
        title={"Economic Analysis & Trends"}
        description="Understand economic indicators, market trends, and policy impacts that shape financial markets and investment opportunities."
      />
