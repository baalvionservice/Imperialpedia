...
export const metadata = buildMetadata({
  title: "Cryptocurrency Investing and Digital Assets",
  description:
    "Stay informed with the latest cryptocurrency investing news, digital asset strategies, and blockchain technology. Our crypto investing section covers Bitcoin, Ethereum, and altcoin investments.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Navigate digital asset markets, cryptocurrency investment strategies, and blockchain technology for modern portfolio diversification."
      />
