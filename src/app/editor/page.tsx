...
export default async function EditorDashboardPage() {
  ...
  // Mock Stats
  const stats = [
    { title: 'Awaiting Review', value: pendingArticles.length.toString(), icon: FileSearch, color: 'text-amber-500' },
    { title: 'Approved Today', value: '4', icon: CheckCircle, color: 'text-emerald-500' },
    { title: 'Revision Requested', value: '2', icon: AlertCircle, color: 'text-primary' },
    { title: 'Average Review Time', value: '4.2h', icon: Clock, color: 'text-secondary' },
  ];

  return (
    <div className="space-y-8 pb-12">
      <header>
        <Text variant="h1" className="text-3xl font-bold">Editorial Command</Text>
          ...
          <CardHeader>
            <div className="flex items-center justify-between">
              <div>
                ...
                <CardDescription>Expert submissions requiring editorial validation.</CardDescription>
              </div>
