...
export default function ApprovedArticlesPage() {
  ...
  return (
    <div className="space-y-8 pb-12">
      <header>
        <Text variant="h1" className="text-3xl font-bold">Approved Intelligence Index</Text>
        <Text variant="bodySmall" className="text-muted-foreground mt-1">
          A historical record of all expert analysis published to the Imperialpedia platform.
        </Text>
      </header>
            ...
            {loading ? (
              ...
              <TableRow key={article.id} className="group">
                <TableCell className="font-bold py-4">
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-emerald-500 font-bold flex items-center gap-1 mt-1">
                      <CheckCircle2 className="h-2.5 w-2.5" /> Published & Indexed
                    </span>
                  </div>
                </TableCell>
                <TableCell>
                ...
                <TableCell className="text-right">
                  <Link href={`/articles/${article.slug}`} target="_blank" className="text-primary hover:underline text-xs inline-flex items-center">
