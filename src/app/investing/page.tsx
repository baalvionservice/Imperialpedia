...
export const metadata = buildMetadata({
  title: "Investing News and Investment Strategies",
  description:
    "Stay informed with the latest investing news, investment strategies, and market analysis. Our investing section covers stocks, bonds, ETFs, and portfolio management to help you build wealth.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Discover investment opportunities, market analysis, and strategies to build and manage your investment portfolio effectively."
      />
