...
export const metadata = buildMetadata({
  title: "Mortgage Rates and Housing Market News",
  description:
    "Stay informed with the latest mortgage rates, housing market trends, and real estate news. Our mortgage section covers interest rate changes and housing market analysis to help you make informed decisions.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Track the latest mortgage rates, housing market trends, and real estate developments that impact homebuyers and investors."
      />
