      ...
      <div className="flex flex-col lg:flex-row gap-12">
        <div className="flex-1 space-y-8">
          <div className="flex items-center justify-between border-b border-white/5 pb-4">
            <Text variant="label" className="text-muted-foreground">
              {loading
                ? "Indexing findings..."
                : `Localized ${results.length} intelligence nodes`}
            </Text>
            <Button
              variant="ghost"
              size="sm"
              className="text-xs font-bold gap-2 uppercase tracking-widest text-primary"
            >
              ...
              <div className="py-24 text-center space-y-6 bg-muted/10 rounded-[3rem] border-2 border-dashed border-white/5">
                ...
                <div className="space-y-2">
                  <Text variant="h3" className="font-bold">
                    No matches localized
                  </Text>
                  <Text
                    variant="bodySmall"
                    className="text-muted-foreground max-w-sm mx-auto leading-relaxed"
                  >
                    We couldn't find any knowledge nodes matching your query in
                    our current index sharding.
                  </Text>
                </div>
                <Button
                  variant="outline"
        ...
        <aside className="lg:w-80 space-y-8">
          <Card className="glass-card p-6 border-none bg-primary/5">
            <Text variant="label" className="text-primary font-bold mb-4 block">
              Refine Taxonomy
            </Text>
            <div className="space-y-2">
              {["Countries", "Companies", "Industries", "Technologies"].map(
                (cat) => (
                  <div
                    key={cat}
                  ...
                  >
                    ...
                    <Badge variant="outline" className="text-[8px] opacity-50">
                      Auto
                    </Badge>
                  </div>
                )
