...
function SearchContent() {
    ...
    if (activeTab !== "all") {
      if (activeTab === "topic") {
        filtered = filtered.filter(
          (r) => r.type === "topic" || r.type === "glossary"
        );
      } else {
  ...
  const getResultIcon = (type: SearchResultType | string) => {
    switch (type) {
      ...
      case "calculator":
        return <CalcIcon className="h-4 w-4 text-primary" />;
      case "glossary":
  ...
  return (
    <Container>
      <header className="mb-12 max-w-3xl mx-auto text-center">
        ...
        >
          Traverse the Imperialpedia Index. Instantly find expert research,
          interactive tools, and financial taxonomies.
        </Text>
      </header>
      ...
      >
        <div className="relative">
          <form
            onSubmit={(e) => handlePerformSearch(undefined, e)}
                  ...
                  {suggestions.map((suggestion) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <Text
                          variant="caption"
                          className="text-muted-foreground uppercase text-[8px] tracking-tighter"
                        >
                          {suggestion.type}
                        </Text>
                      </div>
              ...
              <CardContent className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <Text
                      variant="label"
                      className="text-[10px] opacity-50 ml-1"
                    >
                      Verified Expert
                    </Text>
                    <Select
                    ...
                    >
                      ...
                      <SelectContent>
                        ...
                        <SelectItem value="The Market Maven">
                          The Market Maven
                        </SelectItem>
                        <SelectItem value="Julian Wealth">
                          Julian Wealth
                        </SelectItem>
                        <SelectItem value="Eleanor Vance">
                          Eleanor Vance
                        </SelectItem>
                      </SelectContent>
                    </Select>
                      ...
                      <Card className="glass-card hover:border-primary/40 transition-all group overflow-hidden h-full">
                        <CardContent className="p-4 flex flex-col h-full justify-between">
                          <div className="flex justify-between items-start mb-2">
                            ...
                            {topic.isTrending && (
                              <Badge className="bg-amber-500/10 text-amber-500 border-none text-[8px] px-1.5 h-4 font-bold">
                                HOT
                              </Badge>
                            )}
                          </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <div className="flex justify-center mb-8">
            <TabsList className="bg-card/30 border border-white/5 p-1 h-12 rounded-xl overflow-x-auto no-scrollbar justify-start sm:justify-center w-full sm:w-auto">
              <TabsTrigger
                value="all"
                className="px-6 rounded-lg font-bold text-xs"
              >
                All Findings
              </TabsTrigger>
              <TabsTrigger
                value="article"
                className="px-6 rounded-lg font-bold text-xs gap-2"
              >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 px-2">
              ...
              <div className="flex items-center gap-3 w-full sm:w-auto">
                ...
                <Select
                  value={sortBy}
                  onValueChange={(val) => {
                    setSortBy(val as SearchSortOption);
                    setCurrentPage(1);
                  }}
                >
          ...
          >
            ...
            {isLoading ? (
              ...
              <div className="py-32 text-center bg-card/10 rounded-[3rem] border-2 border-dashed border-white/5">
                ...
                >
                  Broaden your discovery parameters or reset all filters to
                  resume traversal.
                </Text>
                <Button
                  variant="link"
        ...
        <Suspense
          fallback={
            <div className="py-40 flex flex-col items-center justify-center space-y-4">
              ...
              <Text variant="bodySmall" className="animate-pulse">
