...
export const metadata = buildMetadata({
  title: "Earnings Reports and Analysis",
  description:
    "Stay informed with the latest earnings reports, quarterly results, and financial performance analysis. Our earnings section covers company financials and market reactions to help you make informed investment decisions.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Track quarterly earnings, financial performance, and market reactions from companies across all sectors and industries."
      />
