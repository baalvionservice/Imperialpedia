...
export const metadata = buildMetadata({
  ...
  description:
    "Stay informed with the latest Federal Reserve news, monetary policy decisions, and central bank analysis. Our Fed section covers interest rate decisions, policy changes, and economic impact.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Follow Federal Reserve policy decisions, interest rate changes, and monetary policy impacts on markets and the broader economy."
      />
