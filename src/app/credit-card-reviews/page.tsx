...
export const metadata = buildMetadata({
  title: "Credit Card Reviews and Rewards Comparisons",
  description:
    "Stay informed with the latest credit card reviews, rewards program comparisons, and credit card analysis. Our credit card reviews section covers benefits, fees, and rewards optimization.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Compare credit cards, rewards programs, and card benefits to find the best credit card for your spending habits and financial goals."
      />
