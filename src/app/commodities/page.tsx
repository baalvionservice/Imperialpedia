...
export const metadata = buildMetadata({
  title: "Commodities Trading and Raw Materials",
  description:
    "Stay informed with the latest commodities news, raw materials markets, and commodity trading strategies. Our commodities section covers gold, oil, agriculture, and precious metals.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Explore commodities markets, raw materials investing, and alternative assets including gold, oil, and agricultural products."
      />
