...
export default function MonetizationGovernancePage() {
  ...
  const mockRevenueData = [
    { date: 'Jan', revenue: 85000, subscriptions: 4200 },
    { date: 'Feb', revenue: 92000, subscriptions: 4500 },
    { date: 'Mar', revenue: 124500, subscriptions: 5800 },
    { date: 'Apr', revenue: 118000, subscriptions: 5600 },
    { date: 'May', revenue: 145000, subscriptions: 6200 },
    { date: 'Jun', revenue: 168000, subscriptions: 7100 },
  ];
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <Card className="glass-card border-none bg-primary/5 p-8 relative overflow-hidden group">
            ...
            <div className="flex items-center gap-2 text-primary font-bold text-xs uppercase tracking-widest mb-4">
              <ShieldCheck className="h-4 w-4" /> Settlement Node
            </div>
