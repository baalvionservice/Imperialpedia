        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 text-primary mb-1">
              ...
              <Text variant="label" className="text-[10px] font-bold tracking-widest uppercase">Platform Excellence</Text>
            </div>
            <Text variant="h1" className="text-3xl font-bold">Top Performing Content</Text>
          </div>
        </div>
        ...
        {data.slice(0, 3).map((item, idx) => (
          <Card key={item.id} className={cn(
            ...
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-lg line-clamp-2 min-h-[3.5rem]">{item.title}</CardTitle>
              <CardDescription className="text-[10px] font-bold uppercase tracking-widest text-primary">{item.category}</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center justify-between pt-4 border-t border-white/5">
                <div className="space-y-1">
                  <Text variant="label" className="text-[8px] opacity-50">Global Reach</Text>
                  <div className="text-2xl font-bold">{formatCompact(item.views)}</div>
                </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-muted/20 hover:bg-muted/20 border-b border-white/5">
                ...
                <TableHead className="font-bold text-[10px] uppercase tracking-widest text-right">Unique Views</TableHead>
              ...
              {filteredData.map((item, index) => (
                <TableRow key={item.id} className="group hover:bg-muted/10 transition-colors border-b border-white/5">
                  ...
                  <TableCell className="py-5 pl-6">
                    <span className="text-sm font-bold truncate max-w-xs block">{item.title}</span>
                  </TableCell>
                  <TableCell>
