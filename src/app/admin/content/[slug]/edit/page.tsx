...
export default function EditArticlePage() {
  ...
  useEffect(() => {
    ...
    const foundArticle = adminKernel.getArticleBySlug(articleSlug);
    ...
    form.reset({
      ...
      authorName: foundArticle.author.name,
      authorTitle: foundArticle.author.title || "",
      readTimeMinutes: foundArticle.readTimeMinutes,
      imageUrl: foundArticle.imageUrl,
      imageCaption: foundArticle.imageCaption || "",
      featured: foundArticle.featured || false,
      keyTakeaways: foundArticle.keyTakeaways || [],
  ...
  const onSubmit = async (data: ArticleFormData) => {
    ...
    try {
      ...
      adminKernel.saveArticle(updatedArticle);
      toast({
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <Text variant="body" className="text-muted-foreground">
              ID: {article?.id} • Last updated: {article?.updatedAt}
            </Text>
          </div>
        </div>
      </header>
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <Textarea
                    ...
                    onKeyDown={(e) => handleKeyDown(e, addTakeaway)}
