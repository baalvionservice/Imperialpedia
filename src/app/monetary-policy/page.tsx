...
export const metadata = buildMetadata({
  ...
  description:
    "Stay informed with the latest monetary policy news, central bank decisions, and money supply analysis. Our monetary policy section covers Fed policy, interest rates, and banking regulations.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Follow central bank monetary policy decisions, money supply changes, and banking regulations that shape financial markets and economic conditions."
      />
