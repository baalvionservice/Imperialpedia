...
export const metadata = buildMetadata({
  title: "Government and Policy News",
  description:
    "Stay informed with the latest government policies, regulatory changes, and political developments that impact financial markets. Our government section covers fiscal policy, regulations, and political news.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Track government policies, regulatory changes, and political developments that shape financial markets and economic conditions."
      />
