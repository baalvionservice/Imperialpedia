...
export const metadata = buildMetadata({
  title: "Checking Accounts and Banking Services",
  description:
    "Stay informed with the latest checking account options, banking fees, and account features. Our checking section covers account comparisons, fee structures, and banking benefits.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Compare checking accounts, understand banking fees, and find the right account features for your daily banking needs and financial goals."
      />
