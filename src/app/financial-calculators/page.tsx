...
export const metadata = buildMetadata({
  ...
  description:
    "Stay informed with the latest financial calculators, planning tools, and financial analysis resources. Our calculators section covers retirement, mortgage, investment, and budgeting calculators.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Access powerful financial calculators and planning tools to make informed decisions about retirement, investments, loans, and budgeting."
      />
