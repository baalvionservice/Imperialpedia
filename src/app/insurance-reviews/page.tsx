...
export const metadata = buildMetadata({
  title: "Insurance Reviews and Coverage Comparisons",
  description:
    "Stay informed with the latest insurance reviews, coverage comparisons, and insurance company analysis. Our insurance reviews section covers auto, health, life, and property insurance.",
});

// ─── Page ────────────────────────────────────────────────────────────────────

export default function InsuranceReviewsPage() {
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Compare insurance providers, coverage options, and policy features to find the best insurance protection for your needs and budget."
      />
