...
export const metadata = buildMetadata({
  ...
  description:
    "Stay informed with the latest side hustle ideas, income generation strategies, and passive income opportunities. Our income section covers entrepreneurship, freelancing, and wealth building.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Discover side hustle opportunities, income generation strategies, and passive income ideas to boost your earning potential and financial growth."
      />
