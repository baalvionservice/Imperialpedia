...
export const metadata = buildMetadata({
  title: "Retirement Planning and Investment Strategies",
  description:
    "Stay informed with the latest retirement planning news, 401k strategies, and long-term investment approaches. Our retirement section covers retirement accounts, pension plans, and financial planning.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Plan for your financial future with retirement investment strategies, 401k guidance, and long-term wealth building approaches."
      />
