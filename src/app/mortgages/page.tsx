...
export const metadata = buildMetadata({
  title: "Mortgages and Home Financing",
  description:
    "Stay informed with the latest mortgage rates, home financing options, and real estate lending news. Our mortgages section covers loan types, rates, and homebuying strategies.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Navigate mortgage options, compare interest rates, and understand home financing strategies for successful homeownership and refinancing."
      />
