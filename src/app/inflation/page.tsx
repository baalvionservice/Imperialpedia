...
export const metadata = buildMetadata({
  title: "Inflation and Price Trends",
  description:
    "Stay informed with the latest inflation news, price trends, and cost of living analysis. Our inflation section covers CPI data, price changes, and inflation impact on investments.",
});
...
export default function InflationPage() {
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        tag="ECONOMY"
        title={"Inflation & Price Trends"}
        description="Track inflation rates, price trends, and cost of living changes that impact your purchasing power and investment strategies."
      />
