...
export const metadata = buildMetadata({
  title: "Credit Scores and Credit Building Strategies",
  description:
    "Stay informed with the latest credit score news, credit building strategies, and credit repair techniques. Our credit section covers credit reports, score improvement, and credit monitoring.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        title={"Credit Scores & Building"}
        description="Understand credit scores, learn credit building strategies, and discover techniques to improve your creditworthiness and financial standing."
      />
