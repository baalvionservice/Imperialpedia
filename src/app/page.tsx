  ...
  return (
    <div className="flex flex-col w-full">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <Card key={idx} className="glass-card transition-all hover:translate-y-[-4px] hover:shadow-xl hover:shadow-primary/10">
                ...
                <CardContent>
                  <Button variant="link" className="p-0 h-auto text-secondary hover:text-secondary/80 font-bold group">
      ...
      <section className="py-24 text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-headline font-bold mb-6">Designed for 1,000,000+ SEO Pages</h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
            Our architecture prioritizes performance, scalability, and deep indexability to ensure Imperialpedia becomes the primary financial knowledge graph.
          </p>
          <div className="inline-block p-4 rounded-full bg-primary/10 border border-primary/20 text-primary font-bold">
            Currently in Infrastructure Build Phase
          </div>
        </div>
      </section>
    </div>
