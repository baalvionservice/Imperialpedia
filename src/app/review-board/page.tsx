...
import { ReviewBoardMember, reviewBoardMembers } from "./components/data.reviewboards";
    ...
    return (
        <div className="container mx-auto max-w-3xl px-4 py-8">
            <h1 className="text-4xl tracking-wider font-bold mb-6">
                Investopedia Financial Review Board</h1>
            <p className="text-lg leading-7 tracking-wide text-gray-700 mb-4">
            ...
            <div className="mt-8">
                ...
                <p className="mb-3 leading-7 tracking-wide">The Financial Review Board includes experts with more than 100 years of combined financial experience, across every facet of the economy and personal finances. These experts were carefully selected based on their credentials and ability to communicate complex information to a broad readership to ensure our articles are empowering, unbiased, accurate, and inclusive.</p>
                {
    ...
    return (
        <div className="mb-8 py-6 flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
                ...
                <Link href={`/review-board/${profile.slug}`} className="text-blue-400 mt-4 underline hover:no-underline inline-block">
                    Read more
                </Link>
            </div>
        </div>
