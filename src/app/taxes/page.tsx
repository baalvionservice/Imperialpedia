...
export const metadata = buildMetadata({
  title: "Tax Planning and Tax Strategies",
  description:
    "Stay informed with the latest tax news, tax planning strategies, and tax law changes. Our taxes section covers tax optimization, deductions, and filing strategies to minimize your tax burden.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Optimize your tax situation with strategic planning, deduction strategies, and tax-efficient investment approaches to maximize your after-tax income."
      />
