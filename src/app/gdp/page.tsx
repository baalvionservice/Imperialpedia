...
export const metadata = buildMetadata({
  ...
  description:
    "Stay informed with the latest GDP data, economic growth analysis, and productivity trends. Our GDP section covers economic output, growth rates, and economic performance metrics.",
});
  ...
  return (
    <div className=" min-h-screen">
      ...
      <HeadingSection
        ...
        description="Analyze GDP data, economic growth trends, and productivity metrics that measure the health and performance of the economy."
      />
